...
// lock kAIFServiceLockplatform
NSString * const kAIFServiceLockPlatform = @"ServiceLockPlatform";
...
//    }
    ...
    if ([identifier isEqualToString:kAIFServiceLockPlatform]) {
        return [[AIFServiceLockplatfrom alloc] init];
    }
